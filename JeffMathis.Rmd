...
With that out of the way, let's look at how destructive Jeff Mathis is for the Texas Rangers *offense*.

### Expected 2020 Texas Rangers Roster

The official season is a few days away, but rosters are nearly established. Particularly, the roster for the Texas Rangers won't include any surprising names. For this analysis, I included every player with a solid chance at making the Opening Day roster, which consists of these players...
...
From all of this, we can safely say that Jeff Mathis batting is a liability for any team, particularly the Texas Rangers who need additional offensive production. But how much of a liability is he?
...
The mean RC/PA for the Texas Rangers is `r mean(Stats$RCperPA)`. Jeff Mathis has a RC/PA of `r min(Stats$RCperPA)`. Assuming four PAs per game and any other random hitter, Jeff Mathis hitting costs the Rangers 0.4 runs/game. 
...
Especially with expanded rosters (meaning the Rangers can carry three catchers), Chris Woodward and the Rangers should start Jeff Mathis at catcher every home game and use him as defensive reserve in every away game. 

As the home team, Mathis can catch ~3 defensive innings, have 0 PAs, and then be replaced by Chirinos or Trevino in the bottom of the 3th when the catcher's spot comes up to bat. As the visiting team, Mathis can enter the game after the starting catcher's 1st PA, catch ~3 defensive innings, and be replaced by the remaining rostered catcher just before his PA (in case of late-inning emergency, Isiah Kiner-Falefa can be used as a replacement).

Allowing Mathis to catch through about the 5th inning every day starter will give SPs consistency when they toe the rubber. And removing him after 0 or 1 PAs will save the Rangers an expected 0.40 or 0.30 runs/game, on average.  
...
After running a regression on wins by runs scored, I plotted the win probability chart based on the Texas Rangers 2019 season. 
...
Increasing the Rangers mean runs scored by 0.4 increasing win probability by 5.0%. Over 60 games, this increased the Rangers win total from 30.1 to 33.1 games. 
...
Again - defense, particularly catcher defense, is extremely difficult to measure. FanGraphs says that 9-10 Def equals about one win. None of the three catchers are worth one win based on last season if they caught every inning of all 60 games. Jose Trevino is the closed at only 0.75, and Jeff Mathis is actually the worst of the group at 0.08.
